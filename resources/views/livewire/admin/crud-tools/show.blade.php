                    ...
                    <div class="row">
                        ...
                        @if($tool->details)
                                ...
                                <div class="img-single-tools">
                                    ...
                                    @if($tool->details && $tool->details->attach)
                                        <img loading="lazy" src="{{ asset('storage/tools/' . $tool->details->attach) }}"
                                             width="200" alt="{{ $tool->name }}"/>
                                    @else
                                        <img loading="lazy" src="{{ asset('img/default.png') }}" width="200"
                                             alt="{{ $tool->name }}"/>
                                    @endif
                                </div>
                            </div>
                            <div class="col-md-9 row">
                                ...
                                <div class="box-show-detail"
                                     style="{{$tool->details->count < 10 ? 'animation:2s alarm linear infinite' : ''}}">
                        ...
                        @else
                            <span>اطلاعات کامل ابزار ثبت نشده</span>
                        @endif
                    </div>
                </div>
                <hr>
