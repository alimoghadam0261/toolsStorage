        ...
        @if($fromStorage)
            ...
            @if($selectedTool)
                <div class="mb-3">
                    ...
                    <input type="number" wire:model.live="qty" class="form-control w-full" min="1" max="{{ $tools->find($selectedTool)->count }}">
        ...
        @if(count($transferItems) > 0)
            ...
            <div class="overflow-x-auto">
                <table class="min-w-full divide-y divide-gray-200">
                    ...
                    <tr>
                        <th class="px-6 py-3 text-right text-xs font-medium text-gray-500 uppercase tracking-wider">نام ابزار</th>
