    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-md-10">
                ...
                <hr>
                <p> فرم اضافه کردن پرسنل جدید با سطح دسترسی برای سامانه انبار ابزار</p><br>
                {{--                <form class="form-control">--}}
                {{--                    <label for="">نام و نام خانوادگی</label>--}}
                {{--                    <input type="text" class="form-control" placeholder="مثال: علی مقدم"><br>--}}
                {{--                    <label for="">شماره پرسنلی</label>--}}
                {{--                    <input type="text" class="form-control" placeholder="مثال: 3522"><br>--}}
                {{--                    <label for="">نام واحد</label>--}}
                {{--                    <input type="text" class="form-control" placeholder="مثال: صنایع"><br>--}}
                {{--                    <label for="">شماره موبایل</label>--}}
                {{--                    <input type="text" class="form-control" placeholder="  مثال: 09123876533"><br>--}}
                {{--                    <label for="">شماره موبایل</label>--}}
                {{--                    <input type="text" class="form-control" placeholder="  مثال: 09123876533"><br>--}}
                {{--                    <button class="btn btn-outline-success">ثبت نام</button>--}}
                {{--                </form>--}}
                <div class="row">
                    <div class="col-md-4 personal-register">
